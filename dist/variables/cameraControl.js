function roundToFactor(value, factor) {
    return Math.round(value * factor) / factor;
}
export function updateCameraControlVariables(_instance, state, values) {
    ...
    values[`camera_${state.cameraId}_saturation_adjust`] = roundToFactor(state.colorCorrection.colorAdjust.saturation, 1000);
}
export function initCameraControlVariables(_instance, cameraId, variables) {
    variables.push({
