...
export function createProgramFeedbacks(model, state) {
    return {
        ...
        [FeedbackId.ProgramBG2]: model.MEs >= 2
            ? {
                type: 'boolean',
                name: 'ME: Two ME program sources',
                description: 'If the inputs specified are in use by program on the M/E stage specified, change style of the bank',
                options: {
                ...
                callback: ({ options }) => {
                    ...
                    return (me1?.programInput === options.getPlainNumber('input1') &&
            ...
            : undefined,
        [FeedbackId.ProgramBG3]: model.MEs >= 3
            ? {
                type: 'boolean',
            ...
            : undefined,
        [FeedbackId.ProgramBG4]: model.MEs >= 4
            ? {
                type: 'boolean',
