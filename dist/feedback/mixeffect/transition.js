...
import { AtemMEPicker, AtemMatchMethod, AtemRatePicker, AtemTransitionSelectionPicker, AtemTransitionStylePicker, } from '../../input.js';
import { FeedbackId } from '../FeedbackId.js';
import { combineRgb } from '@companion-module/base';
import { getMixEffect } from '../../state.js';
import { calculateTransitionSelection, assertUnreachable } from '../../util.js';
export function createTransitionFeedbacks(model, state) {
    return {
