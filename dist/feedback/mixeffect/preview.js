...
export function createPreviewFeedbacks(model, state) {
    return {
        ...
        [FeedbackId.PreviewBG2]: model.MEs >= 2
            ? {
                type: 'boolean',
                ...
                callback: ({ options }) => {
                    ...
                    return (me1?.previewInput === options.getPlainNumber('input1') &&
            ...
            : undefined,
        [FeedbackId.PreviewBG3]: model.MEs >= 3
            ? {
                type: 'boolean',
            ...
            : undefined,
        [FeedbackId.PreviewBG4]: model.MEs >= 4
            ? {
                type: 'boolean',
