...
import { AtemMEPicker, AtemRatePicker, AtemTransitionSelectComponentsPickers, AtemTransitionSelectionComponentPicker, AtemTransitionSelectionPicker, AtemTransitionStylePicker, } from '../../input.js';
import { ActionId } from '../ActionId.js';
import { AtemCommandBatching, CommandBatching } from '../../batching.js';
import { CHOICES_KEYTRANS, CHOICES_ON_OFF_TOGGLE, NextTransBackgroundChoices, NextTransKeyChoices, } from '../../choices.js';
import { getTransitionProperties, getUSK } from '../../state.js';
import { assertUnreachable, calculateTransitionSelection } from '../../util.js';
export function createTransitionActions(instance, atem, model, commandBatching, state) {
    return {
        ...
        [ActionId.TransitionSelectComponents]: {
            ...
            callback: async ({ options }) => {
                ...
                const nextSelection = [];
                {
                    ...
                    if (include)
                        nextSelection.push(Enums.TransitionSelection.Background);
                }
        ...
        [ActionId.TransitionSelectionComponent]: {
            ...
            callback: async ({ options }) => {
                ...
                if (tp && atem) {
                    ...
                    if (!batch) {
                        batch = new CommandBatching(async (newVal) => atem.setTransitionStyle({
