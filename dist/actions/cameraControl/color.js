...
export function createCameraControlColorActions(config, atem, _state) {
    ...
    const createRgbaAction = (name, doSend) => ({
        name: name,
        options: {
    ...
    return {
        [ActionId.CameraControlColorLiftAdjust]: createRgbaAction('Camera Control: Color Lift Adjust', async (cameraId, red, green, blue, luma) => commandSender?.colorLiftAdjust(cameraId, red, green, blue, luma)),
        [ActionId.CameraControlColorGammaAdjust]: createRgbaAction('Camera Control: Color Gamma Adjust', async (cameraId, red, green, blue, luma) => commandSender?.colorGammaAdjust(cameraId, red, green, blue, luma)),
        [ActionId.CameraControlColorGainAdjust]: createRgbaAction('Camera Control: Color Gain Adjust', async (cameraId, red, green, blue, luma) => commandSender?.colorGainAdjust(cameraId, red, green, blue, luma)),
        [ActionId.CameraControlColorOffsetAdjust]: createRgbaAction('Camera Control: Color Offset Adjust', async (cameraId, red, green, blue, luma) => commandSender?.colorOffsetAdjust(cameraId, red, green, blue, luma)),
