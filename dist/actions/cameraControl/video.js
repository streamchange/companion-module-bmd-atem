...
export function createCameraControlVideoActions(config, atem, _state) {
    ...
    return {
        ...
        [ActionId.CameraControlVideoIncrementManualWhiteBalance]: {
            ...
            callback: async ({ options }) => {
                ...
                const colorTemperature = (_state.atemCameraState.get(cameraId)?.video.whiteBalance[0] ?? 0) + colorTemperatureIncrement;
