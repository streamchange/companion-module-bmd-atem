...
import { CHOICES_KEYTRANS, CHOICES_SSRCBOXES, CHOICES_BORDER_BEVEL, CHOICES_NEXTTRANS_BACKGROUND, CHOICES_NEXTTRANS_KEY, GetAudioInputsList, GetAuxIdChoices, GetDSKIdChoices, GetMediaPlayerChoices, GetMEIdChoices, GetMultiviewerIdChoices, GetSourcesListForType, GetSuperSourceIdChoices, GetTransitionStyleChoices, GetUSKIdChoices, NextTransBackgroundChoices, NextTransKeyChoices, SourcesToChoices, GetUpstreamKeyerTypeChoices, } from './choices.js';
import { iterateTimes, MEDIA_PLAYER_SOURCE_CLIP_OFFSET, compact, NumberComparitor } from './util.js';
export function AtemMESourcePicker(model, state, id) {
    return {
        id: `input${id ? id : ''}`,
...
export function AtemTransitionStylePicker(skipSting) {
    return {
        type: 'dropdown',
        id: 'style',
...
export function AtemUpstreamKeyerTypePicker() {
    return {
        type: 'dropdown',
        id: 'style',
        label: 'Key Type',
...
export function AtemRatePicker(label) {
    return {
        type: 'number',
        id: 'rate',
        label,
...
export function AtemTransitionSelectComponentsPickers(model) {
    const pickers = {
        background: {
            type: 'dropdown',
            id: 'background',
...
export function AtemTransitionSelectionPicker(model) {
    const choices = [{ id: 'background', label: 'Background' }];
    for (let i = 0; i < model.USKs; i++) {
        choices.push({
            id: `key${i}`,
            label: `Key ${i + 1}`,
...
export function AtemTransitionSelectionComponentPicker(model) {
    const options = [
        {
            id: 0,
            label: 'Background',
...
export function AtemMEPicker(model, id) {
    return {
        id: `mixeffect${id ? id : ''}`,
...
export function AtemDSKPicker(model) {
    return {
        type: 'dropdown',
        label: 'Key',
        id: 'key',
...
export function AtemUSKPicker(model) {
    return {
        type: 'dropdown',
        label: 'Key',
        id: 'key',
...
export function AtemAuxPicker(model) {
    return {
        type: 'dropdown',
        id: 'aux',
        label: 'AUX',
...
export function AtemMultiviewerPicker(model) {
    return {
        type: 'dropdown',
        id: 'multiViewerId',
        label: 'MV',
...
export function AtemKeyFillSourcePicker(model, state) {
    return {
        type: 'dropdown',
        label: 'Fill Source',
        id: 'fill',
...
export function AtemKeyCutSourcePicker(model, state) {
    return {
        type: 'dropdown',
        label: 'Key Source',
        id: 'cut',
...
export function AtemAuxSourcePicker(model, state) {
    return {
        type: 'dropdown',
        label: 'Input',
        id: 'input',
...
export function AtemSuperSourceBoxPicker() {
    return {
        type: 'dropdown',
        id: 'boxIndex',
        label: 'Box #',
...
export function AtemSuperSourceIdPicker(model) {
...
export function AtemSuperSourceArtOption(action) {
...
export function AtemSuperSourcePropertiesPickers(model, state) {
    const allProps = {
        size: {
            type: 'number',
            id: 'size',
...
export function AtemSuperSourceArtPropertiesPickers(model, state, action) {
...
export function AtemSuperSourceArtSourcePicker(model, state, id, label) {
    return {
        type: 'dropdown',
        id: id,
        label: label,
...
export function AtemSuperSourceBoxSourcePicker(model, state) {
    return {
        type: 'dropdown',
        id: 'source',
        label: 'Source',
...
export function AtemMultiviewSourcePicker(model, state) {
    return {
        type: 'dropdown',
        id: 'source',
        label: 'Source',
...
export function AtemMultiviewWindowPicker(model) {
...
export function AtemMediaPlayerPicker(model) {
    return {
        type: 'dropdown',
        id: 'mediaplayer',
        label: 'Media Player',
...
export function AtemMediaPlayerSourcePicker(model, state) {
    return {
        type: 'dropdown',
        id: 'source',
        label: 'Source',
...
export function AtemFadeToBlackStatePicker() {
    return {
        type: 'dropdown',
        label: 'State',
        id: 'state',
...
export function AtemMatchMethod() {
    return {
        id: 'matchmethod',
        label: 'Match method',
        type: 'dropdown',
...
export function AtemAudioInputPicker(model, state, subset) {
...
export function AtemFairlightAudioSourcePicker() {
    const sources = [
        {
            id: '-65280',
            label: 'Stereo',
...
export function NumberComparitorPicker() {
    const options = [
...
export const FaderLevelDeltaChoice = {
    type: 'number',
    label: 'Delta',
    id: 'delta',
    default: 1,
...
export function AtemAllSourcePicker(model, state) {
    return {
        type: 'dropdown',
        id: 'source',
        label: 'Source',
